package com.sun.sunmall.controller.common.interceptor;
...
public class AuthorityInterceptor implements HandlerInterceptor{
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        if(StringUtils.isNotEmpty(loginToken)){
            String userJsonStr = shardedRedisCacheUtils.getCache(loginToken,String.class);
            user = shardedRedisCacheUtils.getCache(userJsonStr, User.class);
        }
        ...
        if(user == null || (user.getRole().intValue() != Const.Role.ROLE_ADMIN)){
            ...
            if(user == null){
                if(StringUtils.equals(className,"ProductManageController") && StringUtils.equals(methodName,"richtextImgUpload")){
                    ...
                    out.print((ServerResponse.createByErrorMessage("拦截器拦截,用户未登录")).toString());
                }
            }else{
                if(StringUtils.equals(className,"ProductManageController") && StringUtils.equals(methodName,"richtextImgUpload")){
                    Map resultMap = Maps.newHashMap();
                   ...
                   out.print(resultMap.toString());
                    ...
                    out.print(ServerResponse.createByErrorMessage("拦截器拦截,用户无权限操作").toString());
                }
            }
            out.flush();
            out.close();//这里要关闭
